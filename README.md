...
against seven hand-derived golden answers.
...
harness/
  data/
    supply_chain.json   # mock dataset: 8 suppliers, 7 parts, 11 orders
    test_cases.json      # 7 scenarios with golden answers
...
- [ ] Run `runner.py` against all 7 cases, eyeball `results.json` for parse failures or
...
- [ ] Expand to ~20 cases once the 7-case loop is solid
