...
against six hand-derived golden answers.
...
harness/
  data/
    supply_chain.json   # mock dataset: 6 suppliers, 6 parts, 10 orders
    test_cases.json      # 6 scenarios with golden answers
...
- [ ] Run `runner.py` against all 6 cases, eyeball `results.json` for parse failures or
...
- [ ] Expand to ~20 cases once the 6-case loop is solid
